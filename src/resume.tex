...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Gabriel Faucher

        \vspace{5 pt}

        \normalsize
        \mbox Abel Tasmanplein 173, 9401 AZ Assen%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:gpfaucher@gmail.com}{gpfaucher@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+31628340082}{0628340082}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/gabrielfaucher}{linkedin.com/in/gabrielfaucher}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/gpfaucher}{github.com/gpfaucher}}%
    \end{header}
